                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            <div class="text-uppercase">Mahasiswa Ilmu Komputer · Fotografer · Portofolio Digital</div>
                        </div>

                        <div class="fs-3 fw-light text-muted">Karya dan perjalanan belajarku di dunia teknologi & visual
                        </div>

                        <h1 class="display-3 fw-bolder mb-5">
                            <span class="text-gradient d-inline">Membangun ide dan menangkap momen</span>
                        </h1>

                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="{{ route('about') }}">
                                about
                            </a>

                            <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="{{ route('about') }}">
                                Projects
                            </a>
                        </div>
                    </div>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">My name is Angger Hidayat .</p>
                        <p class="text-muted">Saya Angger Hidayat, seorang mahasiswa Ilmu Komputer yang menikmati proses belajar di dunia teknologi dan visual. Setiap hari saya mencoba memahami bagaimana sistem bekerja, bagaimana sebuah ide berkembang menjadi solusi, dan bagaimana teknologi bisa mendekatkan kita pada banyak kemungkinan baru.

Di sisi lain, saya juga seorang fotografer yang senang menangkap momen — bukan sekadar gambar, tapi cerita yang ada di baliknya. Fotografi bagi saya bukan hanya hobi; itu cara saya melihat dunia dari sudut yang lebih jujur dan lebih dekat.

Bidang komputer memberi saya ruang untuk membangun sesuatu, dan fotografi memberi saya ruang untuk merasakan sesuatu. Dua hal itu justru berjalan berdampingan, membuat saya peka pada detail, teratur dalam bekerja, dan berani mencoba hal baru.

Saat ini saya terus mengembangkan diri di kedua bidang itu: belajar teknologi dengan lebih dalam, dan memperluas pengalaman visual melalui berbagai proyek foto. Tujuan saya sederhana — membuat karya yang bisa dibanggakan dan terus berproses ke arah yang lebih matang.</p>
